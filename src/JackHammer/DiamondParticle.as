package JackHammer 
{
   ...
   * @author David Evans
   */
  public class DiamondParticle extends Sprite
  {
    private var m_Life:Number;
    private var m_Speed:Number;
    
    public function DiamondParticle(life:Number) 
    {
      m_Life = life;
      m_Speed = 0.1 + Math.random() * 10;
      
      var size:Number = 1 + Math.random() * 2;
      ...
      graphics.beginBitmapFill(Resources.DiamondBit.bitmapData, scale, false);
